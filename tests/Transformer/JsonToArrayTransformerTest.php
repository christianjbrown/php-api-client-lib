...
final class JsonToArrayTransformerTest extends TestCase
{
    public function test(): void
    {
        ...
        $actual = $transformer->transform('{"test-key-1": "test-value-1"}', 'test-method', 'test-url', ['test-key-1' => 'test-value-1']);
    ...
    public function testException(): void
    {
        ...
        try {
            $transformer->transform('{"test-invalid-json', 'test-method', 'test-url', ['test-key-1' => 'test-value-1']);
